                ...
                <div class="card-body ">
                    <form action="<?= base_url() ?>jtc/spki/proses-edit-spki" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Kepada" id="kepada" name="kepada" value="<?php echo set_value('kepada', $spki->kepada); ?>">
                            <?= form_error('kepada', '<p style="font-size: 12px;color: red;" class="my-2">', '</p>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="dari" class="form-control-label">Dari</label>
                            <input class="form-control" type="text" placeholder="Dari" id="dari" name="dari" value="<?php echo set_value('dari', $spki->dari); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="PJ Pekerjaan" id="pj" name="pj" value="<?php echo set_value('pj', $spki->pj); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Pengawas Pekerjaan" id="pengawas" name="pengawas" value="<?php echo set_value('pengawas', $spki->pengawas); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Pengawas K3" id="pengawas_k3" name="pengawas_k3" rows="3"><?php echo set_value('pengawas_k3', $spki->pengawas_k3); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Pelaksana" id="pelaksana" name="pelaksana" rows="3"><?php echo set_value('pelaksana', $spki->pelaksana); ?></textarea>
                        ...
                        <div class="mt-4 text-end">
                            <a href=" <?= base_url() ?>jtc/spki" class="btn btn-primary" type="button">Kembali</a>
