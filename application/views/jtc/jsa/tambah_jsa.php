<div class="container-fluid py-0">
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <div class="card-body ">
                    <form action="<?= base_url() ?>jtc/jsa/proses-tambah-jsa" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-4 text-end">
                            <a href=" <?= base_url() ?>jtc/jsa" class="btn btn-primary" type="button">Kembali</a>
