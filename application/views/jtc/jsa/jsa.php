                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="text" id="mulai_pelaksanaan" name="mulai_pelaksanaan" value="<?php echo $jm->mulai_pelaksanaan ?>" disabled>
                                </div>
                                <div class="col-6">
                                    <label for="selesai_pelaksanaan" class="form-control-label">Selesai Pelaksanaan</label>
                                    <input class="form-control" type="text" id="selesai_pelaksanaan" name="selesai_pelaksanaan" value="<?php echo $jm->selesai_pelaksanaan ?>" disabled>
                                </div>
                            </div>
                        </div>
