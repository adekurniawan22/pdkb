<div class="container-fluid py-0">
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <div class="card-body ">
                    <form action="<?= base_url() ?>jtc/histori-alat-kerja/proses-tambah-histori-alat-kerja" method="post" onsubmit="return updateSignatureInput()">
                        <div class="card mb-4">
                        ...
                        <div class="mt-4 text-end">
                            <a href=" <?= base_url() ?>jtc/histori-alat-kerja" class="btn btn-primary" type="button">Kembali</a>
