<div class="container-fluid py-0">
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <div class="card-body ">
                    <form action="<?= base_url() ?>jtc/laporan-pekerjaan/proses-edit-laporan-pekerjaan" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="date" id="mulai_pelaksanaan" name="mulai_pelaksanaan" value="<?php echo set_value('mulai_pelaksanaan', $laporan_pekerjaan->mulai_pelaksanaan); ?>">
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="date" id="selesai_pelaksanaan" name="selesai_pelaksanaan" value="<?php echo set_value('selesai_pelaksanaan', $laporan_pekerjaan->selesai_pelaksanaan); ?>">
                        ...
                        <div class="mt-4 text-end">
                            <a href=" <?= base_url() ?>jtc/laporan-pekerjaan" class="btn btn-primary" type="button">Kembali</a>
