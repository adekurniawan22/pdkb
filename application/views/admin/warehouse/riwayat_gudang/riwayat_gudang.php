                                ...
                                <?php foreach ($riwayat_gudang as $h) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($h->status == 'keluar') : ?>
                                                <?php if ($h->sudah_disetujui == '1') : ?>
                                                    ...
                                                    <button class="btn btn-link text-dark text-gradient px-3 mb-0"><i class="fas fa-pencil-alt me-2" aria-hidden="true" data-bs-toggle="modal" data-bs-target="#status<?= $h->id_riwayat_gudang ?>"></i></button>
                                                <?php else : ?>
                                        ...
                                        <td class="align-middle">
                                            <button class="btn btn-link text-dark text-gradient pe-1 mb-0" data-bs-toggle="modal" data-bs-target="#lihat_alat<?= $h->id_riwayat_gudang ?>"><i class="bi bi-eye-fill me-2" aria-hidden="true"></i>Lihat Alat</button>
                                            <button class="btn btn-link text-danger text-gradient pe-1 mb-0" data-bs-toggle="modal" data-bs-target="#hapus_riwayat_gudang<?= $h->id_riwayat_gudang ?>"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Hapus</button>
                                            <?php if ($h->sudah_disetujui == '1') : ?>
