<div class="container-fluid py-0">
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <div class="card-body ">
                    <form action="<?= base_url() ?>admin/gardu-induk/proses-edit-gardu-induk" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Bay" id="bay" name="bay" value="<?php echo set_value('bay', $gardu_induk->bay); ?>">
