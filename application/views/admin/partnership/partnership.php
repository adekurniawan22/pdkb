            ...
            <div class="card mb-4">
                <div class="row mb-4">
                    ...
                    <div class="col-6 pt-4 text-end">
                        <div class="mx-3">
                            <a href="<?= base_url() ?>admin/partnership/tambah-partnership" class="btn bg-gradient-dark">+ Tambah Partnership</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                <?php foreach ($partnership as $p) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="<?= base_url() ?>admin/partnership/edit-partnership" method="post" class="d-inline-block">
                                                <input type="hidden" name="id_partnership" value="<?= $p->id_partnership ?>">
                                            ...
                                            <button class="btn btn-link text-danger text-gradient m-0 p-2" data-bs-toggle="modal" data-bs-target="#hapus_partnership<?= $p->id_partnership ?>"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Hapus</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
