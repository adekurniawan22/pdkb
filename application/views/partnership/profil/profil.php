    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-profile">
                <div class="card-body">
                    <div class="text-left">
                        ...
                        <div class="h6 mt-4">
                            <span>Nama Manajer : <i class="ni business_briefcase-24 mr-2"></i><?= $profil->manajer ?></span><br>
                            <span>NIP : <i class="ni business_briefcase-24 mr-2"></i><?= $profil->nip ?></span><br>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card card-profilem mt-3">
                ...
                <div class="card-body">
                    <form action="<?= base_url() ?>partnership/edit_tanda_tangan" method="post" onsubmit="return updateSignatureInput()">
                        <input type="hidden" name="id_partnership" value="<?= $profil->id_partnership ?>">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <form action="<?= base_url() ?>partnership/proses-edit-profil-partnership" method="post" enctype="multipart/form-data">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nama ULTG</label>
                                    <input class="form-control" type="text" name="nama_ultg" value="<?= set_value('nama_ultg', $profil->nama_ultg) ?>">
                                    <?= form_error('nama_ultg', '<p style="font-size: 12px;color: red;" class="my-2">', '</p>'); ?>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nama Manajer</label>
                                    <input class="form-control" type="text" name="manajer" value="<?= set_value('manajer', $profil->manajer) ?>">
                    ...
                    <div class="row">
                        <form action="<?= base_url() ?>partnership/proses_edit_password" method="post">
                            <div class="col-md-12">
                                <div class="form-group">
