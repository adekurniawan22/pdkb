                ...
                <div class="card-body ">
                    <form action="<?= base_url() ?>atasan/rencana-operasi/proses-edit-rencana-operasi" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Nama Rencana Pekerjaan" id="nama_rencana" name="nama_rencana" value="<?php echo set_value('nama_rencana', $rencana_operasi->nama_rencana); ?>">
